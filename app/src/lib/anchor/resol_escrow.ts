 ...
 * IDL can be found at `target/idl/resol_escrow.json`.
 */
export type ResolEscrow = {
  "address": "BJbjgczJvjSb4GXPcjDWLPUQdfKRe7SFPCXQqZLcsrBw",
  "metadata": {
    "name": "resolEscrow",
    "version": "0.1.0",
    "spec": "0.1.0",
    "description": "Resol marketplace USDC escrow"
  },
  "instructions": [
    {
      "name": "autoRefund",
      ...
      "accounts": [
        ...
        {
          "name": "usdcMint",
          "address": "B3rGdGRvZjkP1N2BJiRqyeQAm9sCeeP1vbkwzQcWSnSD"
        },
        {
          "name": "buyer",
          "writable": true
    ...
    },
    {
      ...
      "accounts": [
        ...
        {
          "name": "treasury",
          "address": "FvSfLTD5HQGCJa89WP3UzMFrBM12vavjKdvH4iQeizBb"
        },
        {
